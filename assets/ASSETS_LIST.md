...
| `assets/textures/enemies/koopa.png` | Koopa sprite sheet gồm 2 frame đi bộ, 1 frame mai đứng yên và 1 frame mai bắt đầu hồi phục; mỗi frame nằm trong canvas 32×48 px, tổng kích thước 128×48 px. Được cắt từ sprite sheet enemy hiện có. | `[x]` Đã thêm |
