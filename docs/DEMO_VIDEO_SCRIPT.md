...
| 2:55–3:45 | World 1-4 Castle | Dodge 1-2 Firebar rotations; jump over a Podoboo leap; Bowser arena — survive fire breath (varied heights) and hammer throws, then kill him with 5 fireballs (count them); afterwards (second take or continue) grab the AXE -> bridge collapses -> Bowser falls -> Win screen; let the Win music + credits play 5s | Boss fight, invulnerable obstacles, two canonical kill routes, Win state | L4-01, L4-04, L4-05 |
