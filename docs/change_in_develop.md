...
|---|---|---|---|
| 2026-08-21 | [TV5] Merge `feature/sound-input` into `develop` | CTest 31/31 PASS | Fast-forward merged `origin/feature/sound-input` (up to commit `d94e111`). Includes Factory pattern enhancements (`EntityCreator`, `EnemyCreator`, `ItemCreator`, `WorldObjectCreator`), sound manifest & SoundManager updates, CollisionManager & EventBus refinements, runtime package verification cmake script, and full test suite passing (31/31). |
